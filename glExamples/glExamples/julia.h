...
class Julia : public baseClass::application {
public: 
	void start()
	{
		shader = Shader("E:/vsProjects/glExamples/glExamples/shaders/julia/render.vs", "E:/vsProjects/glExamples/glExamples/shaders/julia/render.fs");

		uniforms.zoom = glGetUniformLocation(shader.Program, "zoom");
