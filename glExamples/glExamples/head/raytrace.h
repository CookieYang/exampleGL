...
class RayTrace : public baseClass::application {
public:
	void start()
	{
		max_depth = 5;
	...
	void render(double time)
	{
		...
		glUniform1f(uniforms.aspect, 800.0f / 600.0f);
...
protected:
	void loadShaders()
	{
		prepare = Shader("E:/vsProjects/glExamples/glExamples/shaders/rayTrace/prepare.vs", "E:/vsProjects/glExamples/glExamples/shaders/rayTrace/prepare.fs");

		uniforms.ray_origin = glGetUniformLocation(prepare.Program, "ray_origin");
		uniforms.ray_lookat = glGetUniformLocation(prepare.Program, "ray_lookat");
		uniforms.aspect = glGetUniformLocation(prepare.Program, "aspect");

		raytracer = Shader("E:/vsProjects/glExamples/glExamples/shaders/rayTrace/raytracer.vs", "E:/vsProjects/glExamples/glExamples/shaders/rayTrace/raytracer.fs");

		blit = Shader("E:/vsProjects/glExamples/glExamples/shaders/rayTrace/blit.vs", "E:/vsProjects/glExamples/glExamples/shaders/rayTrace/blit.fs");
	}
